...
public class UserBilling {
	...
	private String userBillingEircode;
	...
	public String getUserBillingEircode() {
		return userBillingEircode;
	}

	public void setUserBillingEircode(String userBillingEircode) {
		this.userBillingEircode = userBillingEircode;
	}
