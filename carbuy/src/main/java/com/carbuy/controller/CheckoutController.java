...
import com.carbuy.service.*;
import com.carbuy.utility.IRLConstants;
import com.carbuy.utility.MailConstructor;
...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") Long cartId,
		...
		List<String> stateList = IRLConstants.listOfIRLCounties;
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
		...
		if (billingSameAsShipping.equals("true")) {
			...
			billingAddress.setBillingAddressEircode(shippingAddress.getShippingAddressEircode());
		}
		...
		if (shippingAddress.getShippingAddressStreet1().isEmpty() 
				...
				|| shippingAddress.getShippingAddressEircode().isEmpty() 
				...
				|| billingAddress.getBillingAddressEircode().isEmpty())
